...
DEFAULT_HF_OCR_ENSEMBLE_MODELS: tuple[str, ...] = (
    "Jhoan12/math-ocr-qwen2.5-vl-3b-geometry-agent-nostradamus-wk01-17-merged-v2",
    "zai-org/GLM-4.5V",
    "Qwen/Qwen2.5-VL-72B-Instruct",
    "Qwen/Qwen2.5-VL-7B-Instruct",
)
MODEL_PREFERENCE: dict[str, int] = {
    "Jhoan12/math-ocr-qwen2.5-vl-3b-geometry-agent-nostradamus-wk01-17-merged-v2": 4,
    "zai-org/GLM-4.5V": 3,
