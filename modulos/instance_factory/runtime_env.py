...
FACTORY_ENV_KEYS = {
    ...
    "HF_OCR_NORMALIZER_BASE_URL",
    "HF_OCR_NORMALIZER_LOCAL_DIR",
    "HF_OCR_NORMALIZER_BASE_MODEL_LOCAL_DIR",
    "HF_OCR_NORMALIZER_PREFER_LOCAL",
    "HF_OCR_NORMALIZER_DEVICE",
    "HF_OCR_NORMALIZER_TIMEOUT",
    "HF_OCR_NORMALIZER_MAX_TOKENS",
    "HF_OCR_NORMALIZER_TEMPERATURE",
    "OPENAI_API_KEY",
    "OPENAI_SCAN_MODEL",
    "PDF_PROBLEM_MODEL",
